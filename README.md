A Terraform/CX as Code remote module for the following Zendesk API operation: Create Ticket
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/zendesk-create-ticket-data-action-module.git?ref=v1.0.0"
...
`Note:` The remote module for creating this data action integration can be found [here](https://github.com/GenesysCloudDevOps/zendesk-data-actions-integration-module "Opens github.com/GenesysCloudDevOps/zendesk-data-actions-integration-module")
